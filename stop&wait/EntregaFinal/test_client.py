...
# Test 1: Mensaje de exactamente 16 bytes
...
# Test 3: Mismo mensaje pero será recibido en dos partes
print("\n=== TEST 3: Mensaje de 19 bytes (recv en 2 partes) ===")
message = "Mensaje de largo 19".encode()
print(f"[DEBUG] Enviando: {message} ({len(message)} bytes)")
client_socketTCP.send(message)
